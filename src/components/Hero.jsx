...
const Hero = () =>  (
    <section id='uvod' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex items-center justify-center md:items-start flex-col xl:px-0 sm:px-16 px-6 gap-5 w-full`}>
        
        <h1 className={`text-white font-grotesk text-[48px] md:text-[54px] font-bold text-center md:text-left w-full leading-tight`}>Vytváříme a spravujeme webové stránky</h1>
        ...
        <div className={`flex flex-col ss:flex-row gap-4`}>
          ...
          <Button link="#o-nas" styles="text-white bg-transparent border hover:bg-white hover:text-primary" text="Více o nás" />
        </div> 
      </div>
